...
// Blit to screen
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float speed, bool useCamera, double angle, int centerX, int centerY)
{
	bool ret = true;

	SDL_Rect dstRect{ x * SCREEN_SIZE, y * SCREEN_SIZE, 0, 0 };
	SDL_Point rotCenter{ centerX * SCREEN_SIZE, centerY * SCREEN_SIZE };
	...
	if (SDL_RenderCopyEx(renderer, texture, section, &dstRect, angle, &rotCenter, flip) != 0)
	{
